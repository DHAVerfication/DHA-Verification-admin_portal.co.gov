...
router.get('/:id', async (req, res) => {
  try {
    ...
    // Return complete permit data as applicant including all fields
    res.json({
      success: true,
      applicant: {
        id: permit.id,
        name: permit.applicantFullName || permit.name || `${permit.surname} ${permit.forename}`,
        surname: permit.surname,
        forename: permit.forename,
        type: permit.type,
        permitNumber: permit.permitNumber || permit.referenceNumber,
        referenceNumber: permit.referenceNumber,
        controlNumber: permit.controlNumber,
        fileNumber: permit.fileNumber,
        ...
        education: permit.education,
        countryOfBirth: permit.countryOfBirth,
        verificationEmail: permit.verificationEmail,
        certificateNumber: permit.certificateNumber,
        parentInfo: permit.parentInfo,
        datePrinted: permit.datePrinted,
        placeOfBirth: permit.placeOfBirth,
        email: permit.email,
        phone: permit.phone,
